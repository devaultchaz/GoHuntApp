...
public class MapsActivity extends FragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setUpMapIfNeeded();
//sets location to current location, changes the map type, and enables zoom buttons
        if(mMap != null) {
            ...
            //sets coordinates for soic
            LatLng soicCoordinates = new LatLng(39.17267, -86.52265);
            mMap.moveCamera(CameraUpdateFactory.newLatLng(soicCoordinates));
            mMap.animateCamera(CameraUpdateFactory.zoomTo(12));

            //sets geo coordinates for zoo and shows up in as a marker
